...
import { View, AppRegistry, StyleSheet, NativeSegmentedControlIOSChangeEvent, DeviceEventEmitter, TouchableOpacity} from "react-native"
...
export default function StaffCall(props: Props) {
    ...
    return (
        ...
        {props.callerType == "staff" ? (
            <View style={styles.container}>
                ...
                <View style={{marginBottom: -20, marginTop: -5, marginRight: -5}}><Lottie loop={true} icon={require('./lottie/icon4.json')} width={50} /></View>
                </TouchableOpacity>
                <TouchableOpacity onPress={create}>
                <View style={{marginBottom: -20, marginTop: -5, marginRight: -5}}><Lottie loop={true} icon={require('./lottie/icon5.json')} width={50} /></View>
                </TouchableOpacity>
