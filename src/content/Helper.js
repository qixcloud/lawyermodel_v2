...
export const appId = "08d25385dfa2178ae17d8901bdc7e8d6";
...
export const getCustomDashboardItems = async () => {
    try {
        ...
        let phaseFluentCaseData = null;

        // used for hyndman and Dial-Law-Firm
        if (appId === '91d9a648e4f46b5ed9918f2276a8ccca' || appId === '08d25385dfa2178ae17d8901bdc7e8d6') {
            const response = await axios({
                method: "get",
                headers: {
                    Authorization: `Bearer ${jwt}`
                },
                url: "https://api.qix.cloud/phaseFluentCase"
            });
            phaseFluentCaseData = response.data;
        } else {
        ...
        return merusCaseData ?? fileVineData ?? phaseFluentCaseData;
    } catch (e) {
